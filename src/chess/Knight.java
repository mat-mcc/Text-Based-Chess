...
public class Knight extends Piece {
    ...
    public Knight(PieceType type, int rank, int file, Player player){
    ...
    public ReturnPiece makeReturnPiece(){
        ...
        if (this.getType() == PieceType.BN){
            Return.pieceType = ReturnPiece.PieceType.BN;
        }
        if (this.getType() == PieceType.WN){
            Return.pieceType = ReturnPiece.PieceType.WN;
        }
